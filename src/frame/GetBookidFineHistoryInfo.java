...
public class GetBookidFineHistoryInfo extends JFrame{
	private DAO dao;
	private JTable jtable;
	
	public GetBookidFineHistoryInfo(String bookid){
		super("罚款历史查询");
		...
		String sql = "select name,card_id,book_name,fine.price,ispay from fine,bookinfo "
				+ "where bookinfo.book_id='" + bookid+"' AND fine.book_name=bookinfo.bookname;";
		dao = new DAO();
