...
public class ReaderChangePasswdFrame extends JFrame implements ActionListener{
	...
	public ReaderChangePasswdFrame(){
		super();
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == confirm){
			dao = new DAO();
			if(dao.readerchangePasswd(indentityCard.getText(), oldpassword.getText(), newpassword.getText())){
