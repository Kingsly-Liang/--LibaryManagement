...
public class GetReaderIDInfo extends JFrame{
	private DAO dao;
	private JTable jtable;
	
	public GetReaderIDInfo(String readerid){
		super("读者查询");
		...
		String sql = "select name,sex,age,indentityCard,date,tel,cardType from reader where indentityCard = '" + readerid +"';";
		dao = new DAO();
